...
| [040](040-parallel-batch.md) | Parallel batch (P2b) | ⛔ Superseded (Phase 2, 2026-05-19) | `subagent_batch` tool + entire batch surface deleted. Parallelism now via LLM parallel tool-use of `subagent`. See `005-architecture-decisions.md` Decision 3 (Superseded) and [`ai-docs/plans/we-want-to-merge-jiggly-meteor.md`](../../plans/we-want-to-merge-jiggly-meteor.md). |
